	...
	<div class="orderMain">
		<form id="orderForm" class="hide" action="/order/create.html"
			...
			<input type="hidden" name="payment"
				value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/100+ 10 }"/>" />
			...
			<input type="hidden" name="orderShipping.receiverDistrict"
				value="昌平区" />
			<input type="hidden" name="orderShipping.receiverAddress"
				value="北京市昌平区北七家镇 修正大厦" />
		</form>
		...
		<div class="orderTbody" style="width: 958px; border-bottom: 0 none;">
			<div class="backToCart">
				<a style="text-decoration: underline;"
					href="http://localhost:86/cart/cart.html">返回修改购物车</a>
			</div>
						...
						<dl class="fl">
							...
							<dd>
								...
								<span class="priceArea">
									¥
									<span id="allPrice">
										<fmt:formatNumber value="${totalPrice / 100 + 10}"
											maxFractionDigits="2" minFractionDigits="2"
											groupingUsed="true" />
									</span>
								</span>
