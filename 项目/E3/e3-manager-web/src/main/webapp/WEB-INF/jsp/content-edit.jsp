	...
	<form id="contentEditForm" class="itemForm" method="post">
		...
		<table cellpadding="5">
			...
			<tr>
				<td>图片:</td>
				<td>
					<input class="onepic" type="hidden" name="pic" />
					<a href="javascript:void(0)" class="easyui-linkbutton onePicUpload">图片上传</a>
					<a href="javascript:void(0)" class="easyui-linkbutton clearOnePic">清除图片</a>
				</td>
			</tr>
			<tr>
				<td>图片2:</td>
				<td>
					<input class="onepic" type="hidden" name="pic2" />
					<a href="javascript:void(0)" class="easyui-linkbutton onePicUpload">图片上传</a>
					<a href="javascript:void(0)" class="easyui-linkbutton clearOnePic">清除图片</a>
				</td>
			</tr>
...
<script type="text/javascript">
	...
	var contentEditPage = {
		submitForm : function() {
			...
			$.post("/content/edit", $("#contentEditForm").serialize(),
					function(data) {
						if (data.status == 200) {
