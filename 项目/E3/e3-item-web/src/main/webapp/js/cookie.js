...
$(function(){
	...
	if($(".topMenu .d2 .dd").length){
		$(".topMenu .d2 .dd").append('<div class="client-promo"><a href="#" target="_blank" rel="nofollow">先摇券 后买单</a></div>');
	}
	if($(".f_ios").length){
		$(".f_ios").find("li:first").html('<a target="_blank" href="#">手机客户端</a>');
	}
	...
	if(ZnowTime >= 1414771200000 && ZnowTime<=1416239999000){
		$('.index_rfloat').html('<a href="#" target="_blank"><img src="http://p.e3mall.cn/gold/images/20141113/20141113111801929.jpg"></a><div class="J_rclose">关闭</div>');
		$('.index_rfloat').show();
	}
	$('.app-android').attr('href','#');
	//右侧广告位关闭
