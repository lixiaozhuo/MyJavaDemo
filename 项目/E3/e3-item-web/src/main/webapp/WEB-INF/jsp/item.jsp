			...
			<div class="pItemsSide">
				<div class="sideWrap">
					<div class="points">
						<ul id="points-sf">
							<li>
								<img src="/images/productattr4.png" />
							</li>
							<li class="has_poptip attr3">
								<img src="/images/productattr3.png" />
							</li>
							<li>
								<img src="/images/productattr2.png" />
							</li>
						</ul>
					</div>
				</div>
				<div class="pdetail">
					<ul>
						<li>
							品牌：
							<span>
								<a href="#" title="我是花吃">我是花吃</a>
							</span>
						</li>
						<li>
							产地：
							<span>
								<a href="#" title="中国">中国</a>
							</span>
						</li>
						<li>重量：1.4kg （含包装）</li>
						<li>商品编号：${item.id }</li>
				...
				<div class="pcommdetail">
					<dl class="prate">
						...
						<dd>
							...
							<strong>
								<span id="positive-num-sf">100</span>
								<span>%</span>
							</strong>
	...
	<div class="pWrap">
			...
			<div class="pDetail">
				<ul class="pTab">
					<li class="curr" pcont-target="div-detail">
						<a title="商品详情" href="javascript:void(0);">商品介绍</a>
					</li>
					<li pcont-target="div-comment">
						<a title="用户评价" href="javascript:void(0);">
							评价
							<b>
								(
				...
				<div id="add-cart-r-btn-sf" class="p-btn">
					<a href="javascript:void(0);" data_url="" pid="${item.id}">加入购物车</a>
				</div>
			</div>
			...
			<div class="pCont" id="div-comment">
				<div class="commentList" id="commandp">
					...
					<div class="commentAll" id="comment-filter-sf">
						...
						<h3>
							<a href="javascript:;" data-type="3">
								差评
								<font>(0)</font>
							</a>
						</h3>
						<h3>
							<a href="javascript:;" data-type="4">
								有晒单
								<font>(0)</font>
							</a>
						</h3>
		...
		<div class="left-box">
			<div id="brandCon" class="catlist" style="">
				...
				<ul class="pClass">
					<li>
						<a href="#" title="半岛月饼">半岛月饼</a>
						<a href="#" title="元朗荣华">元朗荣华</a>
						<a href="#" title="奇华">奇华</a>
						<a href="#" title="迪士尼">迪士尼</a>
						<a href="#" title="宜芝多">宜芝多</a>
						<a href="#" title="日田食品">日田食品</a>
						<a href="#" title="欧美香" style="display: none;">欧美香</a>
						<a href="#" title="零食多" style="display: none;">零食多</a>
						<a href="#" title="我是花吃" style="display: none;">我是花吃</a>
						<a href="#" title="史努比 Snoopy" style="display: none;">史努比
							Snoopy</a>
						<a href="#" title="郭元益" style="display: none;">郭元益</a>
						<a href="#" title="佳宁娜" style="display: none;">佳宁娜</a>
					</li>
				</ul>
				...
				<div class="cm">
					<ul class="l-buy" id="buyrebuy-sf">
						<li>
							<div class="p-img">
								<a  href="#">
									<img src="/images/small_1800005691_1_1_1.jpg" />
								</a>
							</div>
							<div class="title-a">
								<a  href="#">归原Green Yard 有机鲜牛奶 486ml</a>
							</div>
