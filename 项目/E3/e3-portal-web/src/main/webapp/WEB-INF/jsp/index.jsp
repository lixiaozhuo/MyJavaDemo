...
<title>商城-旗下全球美食优选网购商城-进口食品、母婴、营养保健品、生鲜、粮油、酒水饮料、休闲食品-商城lixiaozhuo.com</title>
<meta name="Keywords"
	content="进口食品,网上超市,网上购物,进口奶粉,商城,sfbest,母婴用品,营养保健品,生鲜食品,粮油,酒水,休闲食品">
<meta name="Description"
	content="商城旗下全球美食优选网购商城，精选来自60多个国家和地区的进口食品，正品行货，支持货到付款。销售包括进口奶粉、母婴用品、营养保健品、生鲜食品、粮油、酒水、休闲食品等近万种商品。">
...
<body>
					...
					<c:forEach items="${ad1List}" var="node" varStatus="status">
						<li>
							<a name="sfbest_hp_hp_focus_${status.index }"
								class="fore_pic trackref" href="${node.url }">
								<img id="lunbo_1" alt="${node.title }" src="${node.pic }">
							</a>
						</li>
					</c:forEach>
					<!-- <li>
			  <a name="sfbest_hp_hp_focus_1" class="fore_pic trackref" href="#" > 
	...
	<div class="indexW mt1">
		<div class="bestbuy">
			<div class="b_left">
				...
				<ul class="bbig" id="bigPerfect">
					...
					<li class="price_list0" goods="57111" eid="b_57111_0"
						id="cx_b_57111_0">
						<a href="#" title="湾仔码头 玉米蔬菜猪肉手工水饺 720g">
							<img class="lazy"
								src="/images/html/49111b8189bf71370cdb145f8fdb1195.jpg"
								style="display: inline;">
						</a>
						<div class="gBtn p-btn bbtn" style="top: 260px;">
							<a pid="57111" href="#" indexflag="1">加入购物车</a>
						</div>
					...
					<li class="price_list0" goods="5536" eid="b_5536_0"
						id="cx_b_5536_0">
						<a href="#" title="汾酒 53°20年青花瓷  500ml">
							<img class="lazy" alt="汾酒 53°20年青花瓷  500ml"
								src="/images/html/cf33d7d36f1128577782ded21fe812a9.jpg"
								style="display: inline;">
						</a>
						<div class="gBtn p-btn bbtn">
							<a pid="5536" href="#" indexflag="1">加入购物车</a>
						</div>
				...
				<ul class="bsmall" id="smallPerfect">
					...
					<li class="price_list0" goods="219085" eid="b_219085_1"
						id="cx_b_219085_1">
						<a href="#" title="八马茶业 福鼎白茶(白牡丹）62.5g*2">
							<img class="lazy"
					...
					<li class="price_list0" goods="55213" eid="b_55213_1"
						id="cx_b_55213_1">
						<a href="#" title="爱之湾 桃红莫斯卡托甜起泡酒 750ml">
							<img class="lazy"
			...
			<div class="rSide1">
				...
				<div class="rImg2">
					<a name="sfbest_hp_hp_news_right-ad" class="trackref" href="#">
						<img salt="9.2-9.5"
							src="/images/goods/751d2091c008c2a49c1934545730f041.jpg">
					</a>
				</div>
				...
				<div class="sfNews">
					...
					<ul>
						<li>
							<a name="sfbest_hp_hp_news_1" href="#" class=" red trackref"
								title="受杭州G20峰会影响的配送问题公告">受杭州G20峰会影响的配送问题公告</a>
						</li>
						<li>
							<a name="sfbest_hp_hp_news_2" href="#" class=" trackref"
								title="购买燕麦片满49元抽奖活动中奖公告">购买燕麦片满49元抽奖活动中奖公告</a>
						</li>
						<li>
							<a name="sfbest_hp_hp_news_3" href="#" class=" trackref"
								title="满299抽iPhone6s活动中奖公告">满299抽iPhone6s活动中奖公告</a>
						</li>
						<li>
							<a name="sfbest_hp_hp_news_4" href="#" class=" trackref"
								title="《珍膳米，带你冲上云霄》活动中奖名单公布">《珍膳米，带你冲上云霄》活动中奖名单公布</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="indexW mt2 full_ad"
		...
		<a name="sfbest_hp_hp_banner_1" class="trackref" href="#">
	...
	<div class="indexW mt2 ie6 fresh">
				...
				<li>
					...
					<h2>
						...
						<a name="sfbest_hp_hp_floor1_floor-category1" class="trackref"
							href="#">水果</a>
						&nbsp;&nbsp;
						<a name="sfbest_hp_hp_floor1_floor-category2" class="trackref"
							href="#">蔬菜</a>
					</h2>
				</li>
			</ul>
			<div class="lCont">
				<a name="sfbest_hp_hp_floor1_left-ad" class="trackref" href="#">
					<img alt="8.30-9.5" class="lazy"
		...
		<div class="sfRight">
			<div class="subCont">
				<ul class="pList" id="floor-gap-1">
					<li class="price_list1" eid="l_218031_7_297" goods="218031"
						...
						<div class="pImg">
							<a href="#" title="泰国金柚700-1200g">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="泰国金柚700-1200g" src="/images/goods/160x160-1.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="218031" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="泰国金柚700g-1200g">泰国金柚700g-1200g</a>
						</div>
					...
					<li class="price_list1" eid="l_218155_7_297" goods="218155"
						...
						<div class="pImg">
							<a href="#" title="天山一号火焰山哈密瓜1.4kg-2kg【下单后3-5天发货】">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="天山一号火焰山哈密瓜1.4kg-2kg【下单后3-5天发货】"
									src="/images/goods/160x160-2.jpg" style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="218155" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="天山一号火焰山哈密瓜">天山一号火焰山哈密瓜</a>
						</div>
					...
					<li class="price_list1" eid="l_236853_7_297" goods="236853"
						...
						<div class="pImg">
							<a href="#" title="一点红冬枣1000g">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="一点红冬枣1000g" src="/images/goods/160x160-3.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="236853" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="一点红冬枣1kg">一点红冬枣1kg</a>
						</div>
					...
					<li class="price_list1" eid="l_218955_7_297" goods="218955"
						...
						<div class="pImg">
							<a href="#" title="墨西哥牛油果420g（3个装）">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="墨西哥牛油果420g（3个装）" src="/images/goods/160x160-4.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="218955" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="墨西哥牛油果3粒420g">墨西哥牛油果3粒420g</a>
						</div>
					...
					<li class="price_list1" eid="l_236863_7_297" goods="236863"
						...
						<div class="pImg">
							<a href="#" title="佳沛zespri 佳沛新西兰金奇异果12个（36号）">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="佳沛zespri 佳沛新西兰金奇异果12个（36号）"
									src="/images/goods/160x160-5.jpg" style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="236863" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="佳沛 新西兰金奇异果12个">佳沛 新西兰金奇异果12个</a>
						</div>
					...
					<li class="price_list1" eid="l_236871_7_297" goods="236871"
						...
						<div class="pImg">
							<a href="#" title="国产西梅1000g">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="国产西梅1000g" src="/images/goods/160x160-6.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="236871" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="国产西梅1kg">国产西梅1kg</a>
						</div>
					...
					<li class="price_list1" eid="l_218073_7_297" goods="218073"
						...
						<div class="pImg">
							<a href="#" title="新西兰红玫瑰苹果720g(4个装)">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="新西兰红玫瑰苹果720g(4个装)" src="/images/goods/160x160-7.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="218073" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="新西兰红玫瑰苹果4粒720g">新西兰红玫瑰苹果4粒720g</a>
						</div>
					...
					<li class="price_list1" eid="l_215405_7_297" goods="215405"
						...
						<div class="pImg">
							<a href="#" title="皇冠蜜梨1000g（4个装）">
								<img class="lazy" data="/images/goods/160x160.jpg"
									alt="皇冠蜜梨1000g（4个装）" src="/images/goods/160x160-8.jpg"
									style="display: block;">
							</a>
							<div class="gBtn p-btn">
								<a pid="215405" data_url="/images/goods/160x160.jpg" href="#"
									indexflag="1">加入购物车</a>
							</div>
						</div>
						<div class="title-a">
							<a href="#" title="皇冠蜜梨4粒1kg">皇冠蜜梨4粒1kg</a>
						</div>
			...
			<div class="redge">
				<ul class="rHot">
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords1" class="trackref" href="#">蓝莓</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords2" class="trackref" href="#">椰青</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords3" class="trackref" href="#">火龙果</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords4" class="trackref" href="#">水蜜桃</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords5" class="trackref" href="#">牛油果</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords6" class="trackref" href="#">佳沛</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords7" class="trackref" href="#">新奇士</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords8" class="trackref" href="#">加工蔬菜</a>
					</li>
					<li>
						<a name="sfbest_hp_hp_floor1_Keywords9" class="trackref" href="#">加利利</a>
					</li>
				</ul>
				<div class="clr"></div>
				<div class="rimg">
