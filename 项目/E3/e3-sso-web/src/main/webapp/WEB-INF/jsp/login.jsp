...
<body>
	...
	<div class="login_main clear">
		<div class="pic">
			<a href="#">
				<img src="/images/06f42c372620f92b40da77a8b23cdf7f.png" />
			</a>
		</div>
		<!-- login -->
		<div class="login">
					...
					<ul>
						<form id="formlogin" method="post">
							...
							<li>
								<span class="title">
									手机/验证邮箱/用户名
									<font style="padding-left: 20px" class="error_line"
										color="#ff0000"></font>
								</span>
								<span class="border" style="position: relative">
									<input id="username" name="username" type="hidden"
										accesskey="n" value="" size="25" autocomplete="off" />
									<input class="new-input1 new-color" tabindex="1"
	...
	<div class="footer">
		...
		<p>
			北京XX电子商务有限公司
			<br />
			北京市公安局顺义分局备案1101130200XXXX号|
			<a href="#" rel="nofollow" class="footerlink1">京ICP备120113XX号</a>
			|
