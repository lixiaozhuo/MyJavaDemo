...
<body>
		...
		<ul class="individualUserBg">
			<form id="regForm_mod" name="regForm_mod" method="post">
				...
				<li>
					...
					<span class="regM defaultBorder">
						<input id="pwd" name="password" class="regInput"
				...
				<li class="regMb30">
					...
					<span class="regM defaultBorder">
						<input id="pwdRepeat" name="password2" autocomplete="off"
							class="regInput" type="password"
							onfocus="showtip('password2','password2Err',3);"
							onblur="ckpwd2();" />
						<em></em>
					</span>
				...
				<li class="regMb30">
					...
					<span class="regM defaultBorder">
						<input id="phone" name="phone" autocomplete="off" class="regInput"
				...
				<li class="regPl88">
					<span class="regM" style="margin-left: 29px">
						<input id="AgreeId" name="AgreeId" type="checkbox" checked=""
							onclick="ckAgree();" />
						<a href="#" class="checkTitle">
							我已阅读并同意
							<font style="font-size: 12px;">《商城用户注册协议》</font>
						</a>
					</span>
	...
	<div class="footer">
		...
		<p>
			...
			<a href="#" rel="nofollow" class="footerlink1">京ICP备12011349号</a>
			|
			<a href="#" rel="nofollow" class="footerlink1">企业营业执照</a>
			<br />
			Copyright© lixiaozhuo.com 版权所有
			<br />
		</p>
	</div>
	<!-- /footer -->
