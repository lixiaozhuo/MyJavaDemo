...
<body>
	<form name="editForm" action="/role_save" method="post" id="editForm">
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<input type="text" name="sn" cssClass="ui_input_txt02"
								value='${role.sn}' />
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							<table>
								<tr>
									<td>
										<form:select name="" path="permissions" multiple="true"
											cssClass="ui_multiselect01 all_permissions">
											<form:options items='${permissions}' itemValue="id"
												itemLabel="name" />
										</form:select>
									</td>
									<td align="center">
									...
									<td>
										<form:select name="permId" path="permissions" multiple="true"
											cssClass="ui_multiselect01 selected_permissions" >
											<form:options items='${role.permissions}' itemValue="id"
												itemLabel="name" />
										</form:select>
									</td>
								</tr>
