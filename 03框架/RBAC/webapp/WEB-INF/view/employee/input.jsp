...
<body>
	<s:form name="editForm" namespace="/" action="employee_save"
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left"
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#depts" name="employee.dept.id" listKey="id"
					...
					<tr>
						...
						<td class="ui_text_lt">
							...
							&nbsp;
							<s:reset id="cancelbutton" value="重置" cssClass="ui_input_btn01"/>
						</td>
					</tr>
				</table>
			</div>
